...
Refinery::Core.configure do |config|
  ...
  # Site name
  config.site_name = "MUDr. Iva Poláčková - Praktická stomatologie"
  ...
  # config.dragonfly_secret = "e4ad7281d5c02cd640eef3870270d605500cace7cc605cad"
